    ...
    <div>
        ...
        <form className='flex flex-col w-3/12 p-12 my-36 left-0 right-0  mx-auto items-center justify-center absolute rounded-md bg-black opacity-90'>
            ...
            <div className='flex flex-col'>
                ...
                <input value={email} onChange={((e)=> setFullName(e.target.value))} type='email' placeholder='Email' className='outline-none p -3 my-2 rounded-sm bg-gray-800 text-white'/>
                <input value={password} onChange={((e)=> setFullName(e.target.value))} type='password' placeholder='password' className='outline-none p -3 my-2 rounded-sm bg-gray-800 text-white'/>
