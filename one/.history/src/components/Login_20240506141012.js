    ...
    <div>
        ...
        <form className='flex flex-col w-3/12 p-12 my-36 left-0 right-0  mx-auto items-center justify-center absolute rounded-md bg-black opacity-90'>
            ...
            <div className='flex flex-col'>
                ...
                <p className='text-white'>{isLogin? 'already have an acount':"new to netflix"}<span className='ml-1 text-blue-900 font-medium' onClick={loginHandler}>{isLogin?'Signup':'Login'}</span></p>
